...
class TokoObatAdmin extends StatefulWidget {
  const TokoObatAdmin({Key? key}) : super(key: key);

  @override
  State<TokoObatAdmin> createState() => _TokoObatAdminState();
}

class _TokoObatAdminState extends State<TokoObatAdmin> {
                    ...
                    return _MedicineCard(
                      ...
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Anda memilih $medicineName'),
                          ),
                        );
                      },
                    );
