...
import 'package:mob3_uas_klp_09/UI_anggota/RiwayatPembayaran.dart';
import 'package:mob3_uas_klp_09/UI_anggota/checkupAngota.dart';
import 'package:mob3_uas_klp_09/UI_anggota/profil_anggota/profilAnggota.dart';
...
class DasboardAnggota extends StatelessWidget {
  final String username;

  const DasboardAnggota({Key? key, required this.username}) : super(key: key);
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(builder: (context) => const TokoObatAnggota()),
                              );
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context)=> MedicalCheckupAnggota()));
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {Navigator.of(context).push(
                        ...
                        print('Navigasi ke Riwayat Saya');
                      },
                      child: _buildNavItem(Icons.access_time, 'Riwayat Saya', false),
                    ),
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Profilanggota()));
